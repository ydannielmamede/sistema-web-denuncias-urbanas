...
class Denuncia(models.Model):
    ...
    foto_1 = models.ImageField(upload_to='denuncias/', max_length=500, null=True, blank=True, db_column='Foto_1')
    foto_2 = models.ImageField(upload_to='denuncias/', max_length=500, null=True, blank=True, db_column='Foto_2')
    foto_3 = models.ImageField(upload_to='denuncias/', max_length=500, null=True, blank=True, db_column='Foto_3')
    foto_4 = models.ImageField(upload_to='denuncias/', max_length=500, null=True, blank=True, db_column='Foto_4')
    foto_5 = models.ImageField(upload_to='denuncias/', max_length=500, null=True, blank=True, db_column='Foto_5')
